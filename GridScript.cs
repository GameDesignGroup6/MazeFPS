...
public class GridScript : MonoBehaviour
{
    ...
    void FindNext()
    {
        ...
        {
            if (cell.renderer.material.color == Color.black) continue;
            isDeadEnd -= 1;
        }
        if (isDeadEnd == 0)
        {
            int chance = Random.Range(0, 10);
            if (chance < 5) next.renderer.material.color = Color.blue;
            if (chance >= 5) next.renderer.material.color = Color.yellow;
        }
